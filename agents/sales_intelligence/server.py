"""Sales Intelligence Agent — A2A HTTP server.

Wraps SalesIntelligenceAgent behind two endpoints:
...
observability.setup("sales_intelligence_agent")

from fastapi import FastAPI, Request as FastAPIRequest  # noqa: E402
from pydantic import BaseModel, Field  # noqa: E402
import uvicorn  # noqa: E402

from agents.sales_intelligence.agent import SalesIntelligenceAgent  # noqa: E402
...
_agent: Optional[SalesIntelligenceAgent] = None
